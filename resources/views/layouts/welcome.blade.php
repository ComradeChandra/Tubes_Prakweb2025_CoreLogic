...
<section class="bg-gray-900 bg-[url('https://images.unsplash.com/photo-1595590424283-b8f17842773f?q=80&w=2070&auto=format&fit=crop')] bg-no-repeat bg-cover bg-center bg-blend-multiply">
    <div class="px-4 mx-auto max-w-7xl text-center py-24 lg:py-56">
        ...
        <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
            Menyediakan solusi keamanan taktis tingkat militer. Dari pengawalan VIP hingga operasi pengawalan di zona konflik. Keamanan Anda adalah misi mutlak kami.
        </p>
        
        {{-- TOMBOL KONSULTASI DAN KATALOG --}}
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            
            {{-- Tombol 1: Katalog --}}
            <a href="/catalog" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-900 shadow-lg shadow-red-900/50">
                LIHAT KATALOG UNIT
            ...
            {{-- Tombol 2: Konsultasi --}}
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-gray-500 hover:bg-gray-700 focus:ring-4 focus:ring-gray-800 transition">
                KONSULTASI
            </a>
...
<section class="bg-gray-900 py-10 px-4">
    <div class="max-w-7xl mx-auto text-center">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="p-6 bg-gray-800 rounded-lg border border-gray-700 hover:border-red-900 transition duration-300">
            ...
            <div class="p-6 bg-gray-800 rounded-lg border border-gray-700 hover:border-red-900 transition duration-300">
                <div class="text-red-500 text-4xl mb-4">⚔️</div>
                <h3 class="text-xl font-bold text-white mb-2">Proven</h3>
