...
<section class="relative bg-gray-900 bg-[url('https://images.unsplash.com/photo-1595590424283-b8f17842773f?q=80&w=2070&auto=format&fit=crop')] bg-no-repeat bg-cover bg-center bg-blend-multiply">
    ...
    <div class="relative px-4 mx-auto max-w-7xl text-center py-24 lg:py-48">
        <div class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm rounded-full bg-gray-800 text-white hover:bg-gray-700 border border-gray-600" role="alert">
            <span class="text-xs bg-red-600 rounded-full text-white px-4 py-1.5 mr-3">NEW</span> <span class="text-sm font-medium">Cyber Security Division Available</span> 
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="bg-gray-900 p-6 rounded-lg border border-gray-700 relative">
                ...
                <p class="text-gray-300 italic mb-6 relative z-10 pt-4">
                    "CoreLogic has been our trusted security partner for over five years. Their team is highly professional, discreet, and always prepared. They handle our executive protection needs with absolute precision."
                </p>
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center font-bold text-white">VK</div>
                    <div>
            ...
            <div class="bg-gray-900 p-6 rounded-lg border border-gray-700 relative">
                <div class="text-red-600 text-5xl absolute top-4 left-4 opacity-20">"</div>
                <p class="text-gray-300 italic mb-6 relative z-10 pt-4">
                    "Operating in high-risk environments requires a security team you can rely on completely. CoreLogic provides that peace of mind. Their logistical support and perimeter security are second to none."
                </p>
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center font-bold text-white">HR</div>
                    <div>
                        <div class="text-white font-bold text-sm">H. Rahman</div>
                        <div class="text-red-500 text-xs uppercase">Director of Operations, Apex Energy</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-900 p-6 rounded-lg border border-gray-700 relative">
                <div class="text-red-600 text-5xl absolute top-4 left-4 opacity-20">"</div>
                <p class="text-gray-300 italic mb-6 relative z-10 pt-4">
                    "I value the safety of my family above all else. The CoreLogic team is respectful, unobtrusive, and incredibly effective. I highly recommend their services to anyone requiring top-tier protection."
                </p>
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center font-bold text-white">ST</div>
                    <div>
